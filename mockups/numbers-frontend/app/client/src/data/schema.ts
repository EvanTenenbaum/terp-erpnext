...
export const DOCTYPES: DocTypeDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "posting_date", label: "Date", type: "date", width: 110 },
      { name: "voucher_type", label: "Voucher", type: "data", width: 130 },
    ],
  },
  {
    ...
    fields: [
      { name: "name", label: "Item Code", type: "data", width: 130 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "due_date", label: "Due", type: "date", width: 110 },
      { name: "grand_total", label: "Total", type: "currency", width: 120 },
      { name: "outstanding_amount", label: "Outstanding", type: "currency", width: 120 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "party", label: "Party", type: "data", width: 200 },
      { name: "posting_date", label: "Date", type: "date", width: 110 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "posting_date", label: "Date", type: "date", width: 110 },
      { name: "voucher_type", label: "Voucher", type: "data", width: 140 },
